window.BS_DEFAULT_DATA = {
  ...
  points:[
    ...
    {id:'payw1', no:'PW1', zone:'BAY WEST', title:'BAY-WEST-1', x:4.8, y:63.8, risk:'safe', guard:'lg1', instruction:'متابعة نزول العملاء في بداية قطاع BAY WEST.'},
    {id:'payw2', no:'PW2', zone:'BAY WEST', title:'BAY-WEST-2', x:7.9, y:63.8, risk:'safe', guard:'lg2', instruction:'متابعة الأطفال ومنع الخروج خارج منطقة السباحة.'},
    {id:'payw3', no:'PW3', zone:'BAY WEST', title:'BAY-WEST-3', x:11.6, y:63.8, risk:'safe', guard:'lg3', instruction:'متابعة حركة الموج القريبة من الشاطئ.'},
    {id:'payw4', no:'PW4', zone:'BAY WEST', title:'BAY-WEST-4', x:15.5, y:63.8, risk:'safe', guard:'lg4', instruction:'نقطة متابعة عامة في BAY WEST.'},
    {id:'payw5', no:'PW5', zone:'BAY WEST', title:'BAY-WEST-5', x:20.0, y:63.8, risk:'safe', guard:'lg5', instruction:'نقطة ما قبل مارينا BAY، متابعة حركة العملاء.'},

    // PAY marina - 2 lifeguards
    {id:'paym1', no:'PM1', zone:'BAY MARINA', title:'PAY-MARINA-1', x:17.9, y:56.8, risk:'danger', guard:'lg6', requiredGuards:2, marina:true, instruction:'مارينا PAY: مسموح القفز فقط عند الراية الخضراء. ممنوع النزول تحت المارينا نهائياً.'},
    {id:'paym2', no:'PM2', zone:'BAY MARINA', title:'PAY-MARINA-2', x:18.9, y:51.8, risk:'danger', guard:'', requiredGuards:2, marina:true, instruction:'المنقذ الثاني على مارينا PAY. التركيز على منع أي عميل من النزول تحت المارينا.'},

    // PAY EAST shore points
    {id:'paye1', no:'PE1', zone:'BAY EAST', title:'BAY-EAST-1', x:25.6, y:63.8, risk:'safe', guard:'', instruction:'بداية قطاع PAY EAST.'},
    {id:'paye2', no:'PE2', zone:'BAY EAST', title:'BAY-EAST-2', x:31.0, y:63.5, risk:'safe', guard:'', instruction:'نقطة متابعة عامة.'},
    {id:'paye3', no:'PE3', zone:'BAY EAST', title:'BAY-EAST-3', x:35.6, y:63.4, risk:'safe', guard:'', instruction:'نقطة متابعة عامة.'},
    {id:'paye4', no:'PE4', zone:'BAY EAST', title:'BAY-EAST-4', x:41.3, y:63.2, risk:'safe', guard:'', instruction:'نقطة متابعة عامة.'},
    {id:'paye5', no:'PE5', zone:'BAY EAST', title:'BAY-EAST-5', x:46.0, y:63.2, risk:'safe', guard:'', instruction:'نقطة متابعة عامة.'},
    {id:'paye6', no:'PE6', zone:'BAY EAST', title:'BAY-EAST-6', x:51.2, y:63.1, risk:'safe', guard:'', instruction:'نقطة نهاية قطاع PAY قبل الفاصل.'},
